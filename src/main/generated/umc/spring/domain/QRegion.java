...
public class QRegion extends EntityPathBase<Region> {
    ...
    public final ListPath<umc.spring.domain.store.domain.Store, umc.spring.domain.store.domain.QStore> stores = this.<umc.spring.domain.store.domain.Store, umc.spring.domain.store.domain.QStore>createList("stores", umc.spring.domain.store.domain.Store.class, umc.spring.domain.store.domain.QStore.class, PathInits.DIRECT2);
